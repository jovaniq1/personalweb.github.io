...
import splashAnimation from "./assets/lottie/tags.json"; // Rename to your file name for custom animation
  ...
  experience: [
    {
      ...
      desc: "Developed multiple food ordering Apps for IOS and Android using react native. Designed and developed a new product that integrated with the POS system called KwicskTable, a wait list and reservation website for restaurants",
      descBullets: ["Developed Apps and Web apps"]
    },
    {
      role: "IT Specialist",
      company: "Kwickpos",
    ...
    },
    {
      ...
      desc: "Developed an app for Anesthesiologists to quickly log input data and keep track of a patient’s status instead of writing on paper while in surgery. The app will help optimize time, track accurate data for a successful surgery all while keeping a record, and reduce cost for expensive equipment to keep track of patient status."
    }
  ]
};
...
const contactInfo = {
  ...
  subtitle: "Contact me at",
  number: "+1-832-945-0756",
  email_address: "jcasarrubiasq1@gmail.com"
};

// Twitter Section

const twitterDetails = {
  userName: "jovani_q1", //Replace "twitter" with your twitter username without @
  display: true // Set true to display this section, defaults to false
};
